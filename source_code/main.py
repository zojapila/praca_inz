...
pso_results = "C:/praca_inz/source_code/pso_results40.csv"
...
start = time.time()
pso = pso.ParticleSwarmOptimization(processed_data, population_size=40, max_iter=5, final_sol_num=20, filenum=40)
