...
import testing.ga_testing as ga_test
import time
...
ga_results = 'C:/praca_inz/source_code/ga_results3.csv'
...
# ga
start = time.time()
genetic_algorithm = ga.GeneticAlgorithm(processed_data, initial_population_size=800, max_iter=20, num_of_final_sol=300)
result = genetic_algorithm.geneticAlgorithmLoop()
end = time.time()
print(end - start)
res_ga = ga_test.GATesting(testing_data, ga_results)
res_ga.testGA()
# print(result.head())
# pso
